TELEGRAM CHANNELS MONITOR helps monitor channels for messages with certain keywords (Monitoring telegram channels messages by keywords and forward them to your telegram bot).
